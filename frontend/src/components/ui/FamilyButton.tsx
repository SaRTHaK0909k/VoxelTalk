  ...
  return (
    <div
      className={cn(
        ...
        isExpanded
          ? "w-[124px] bg-gradient-to-b dark:from-stone-900 dark:to-neutral-900/80"
    ...
    >
      ...
      >
        {isExpanded ? (
          ...
          <motion.div
            className={cn(
              "p-[10px] group bg-neutral-200 hover:bg-neutral-400 dark:bg-cyan-500/90 text-cyan-50 border border-cyan-100/10  shadow-2xl transition-colors duration-200"
            )}
